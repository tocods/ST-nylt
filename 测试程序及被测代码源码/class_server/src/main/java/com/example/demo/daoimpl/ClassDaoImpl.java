...
public class ClassDaoImpl implements ClassDao {
    ...
    @Override
    public Class getClassForCollect(int classId)
    {
        Class choose = classRepository.getClassById(classId);
        int lk = choose.getClassDetail().getLikes();
        choose.getClassDetail().setLikes(lk+1);
        return choose;
    }
    ...
    @Override
    public Uris getUris(int classId, int from)
    {
