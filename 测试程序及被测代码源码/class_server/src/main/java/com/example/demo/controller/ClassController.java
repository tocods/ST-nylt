...
public class ClassController {
    ...
    Class getClassById(@RequestParam("classId")int classId)
    {
        return classServer.getClassById(classId,1);
    }
    ...
    @RequestMapping("/getRankToday")
    List<Rank> getRankToday(){return redisRankService.listRankToday();}

    @RequestMapping("/getRank")
    List<Rank> getRankAll(){
        Rank rank = new Rank(0,0,"0");
        return redisRankService.listRank();
    }
