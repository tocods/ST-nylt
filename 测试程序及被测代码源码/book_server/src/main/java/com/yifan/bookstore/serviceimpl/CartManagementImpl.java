...
/*mport com.yifan.bookstore.dao.BookDao;
...
@Service
public class CartManagementImpl  {
    @Autowired
...
final String description=(String)document.getFirstValue("description");
    ...
    public String addCart(HttpSession httpSession, String usn,Integer book_id){
    ...
    public String fetchCart(HttpSession httpSession,String usn) {
        if (usn != null) httpSession.setAttribute("user", usn);
        if (httpSession.getAttribute("user") == null && usn == null) {
            return "Not logged in";
        }
        String username = usn;
